...
# Build a portable bundle of TransFS artifacts for RetroNAS Ansible integration.
# Usage:
#   ./build_retronas_artifacts.sh [output_dir]

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "${SCRIPT_DIR}/../../.." && pwd)"
OUT_DIR="${1:-${RETRONAS_ARTIFACTS_OUT:-${REPO_ROOT}/artifacts/retronas}}"
...
cp "${REPO_ROOT}/platform/linux/retronas/register_transfs_menu.sh" "${BUNDLE_DIR}/platform/linux/retronas/"

cp "${REPO_ROOT}/platform/linux/retronas/ansible/install_transfs.yml" "${BUNDLE_DIR}/platform/linux/retronas/ansible/"
cp "${REPO_ROOT}/platform/linux/retronas/ansible/inventory.example.ini" "${BUNDLE_DIR}/platform/linux/retronas/ansible/"
cp "${REPO_ROOT}/platform/linux/retronas/ansible/README.md" "${BUNDLE_DIR}/platform/linux/retronas/ansible/"
cp "${REPO_ROOT}/platform/linux/retronas/ansible/templates/transfs-retronas.service.j2" "${BUNDLE_DIR}/platform/linux/retronas/ansible/templates/"
cp "${REPO_ROOT}/platform/linux/retronas/ansible/templates/transfs-retronas.env.j2" "${BUNDLE_DIR}/platform/linux/retronas/ansible/templates/"
...
echo "RetroNAS artifacts exported to: ${OUT_DIR}/transfs-retronas-installer"
echo "RetroNAS artifacts archive: ${ARCHIVE_PATH}"